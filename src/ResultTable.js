...
function VerticalAxis() {
  return <line x1={AxisPadding*Width} y1={0} x2={AxisPadding*Width} y2={(1-AxisPadding)*Height} className="axis" />
}

function HorizontalAxis() {
  return <line x1={AxisPadding*Width} y1={(1-AxisPadding)*Height} x2={Width} y2={(1-AxisPadding)*Height} className="axis" />
}
...
console.error({x, dateHeight})
    ...
    return <text key={index} x={x} y={dateHeight} 
     className="date-text">{month} {day}</text>
  })
}
